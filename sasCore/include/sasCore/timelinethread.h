...
namespace SAS {
	...
	public:
        ...
        Id add(std::chrono::system_clock::duration timeout, Func func, const std::string & handlerDescriptor, long cycle = 1); //cycle=-1 to infinity

        Id add(std::chrono::system_clock::time_point timestamp, Func func, const std::string & handlerDescriptor);

        Id add(std::chrono::system_clock::time_point timestamp, std::chrono::system_clock::duration period, Func func, const std::string & handlerDescriptor, long cycle);
